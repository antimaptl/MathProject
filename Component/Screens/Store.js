      ...
      <ScrollView contentContainerStyle={{ padding: scale(16) }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: scale(20) }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <Image source={require('../Screens/Image/coins.png')} style={{ width: scale(24), height: scale(30),marginRight: scale(37)}} />
          </View>
        </View>
        ...
        {[1, 2].map(i => (
          <View key={i} style={{ backgroundColor: '#D9D9D9', borderRadius: scale(10), padding: scale(16), flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: scale(10) }}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Image source={require('../Screens/Image/coins.png')} style={{ width: scale(24), height: scale(24), marginRight: scale(8) }} />
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: scale(20) }}>
          {[1000, 4000, 8000].map((amount, index) => (
            <TouchableOpacity
              ...
              <Image source={require('../Screens/Image/coins.png')} style={{ width: scale(30), height: scale(30), marginBottom: scale(5),marginRight:-6,}} />
              <Image source={require('../Screens/Image/coins.png')} style={{ width: scale(30), height: scale(30), marginBottom: scale(5) }} />
              <Image source={require('../Screens/Image/coins.png')} style={{ width: scale(30), height: scale(30), marginBottom: scale(5),marginTop:-17,marginStart:-39 }} />
              </View>
